           ...
           <div class="card-body">
              <form method="post" id="registerform">
				  ...
				  <div class="form-group">
				    ...
				    <input type="file" class="form-control d-none" id="file" name="file" multiple > <!-- 실제 기능 -->
...
$(function() {
	...
	$("#btnReg").click(function() {
		...
		$("#registerform").append(str).submit();//form 태그에 추가 -> 페이지가 넘어가며 글 등록/수집된 첨부파일이 리스트 형태로 보여짐
